...
(function (App) {
    ...
    App.doc.ready(function() {
        ...
        App.modules.select = new App.Select();
        App.modules.good = new App.GoodCarousel();
        App.modules.clients = new App.ClientsCarousel();

    });

    App.GoodCarousel = (function(App){
    ...
    App.ClientsCarousel = (function(App){

        "use strict";
        var module =  function(opts) {

            this.options = {
                self: '.js-clients-carousel'
            };
            this.options = $.extend(this.options, opts);
            this.$root = $(this.options.self);
